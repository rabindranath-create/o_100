...
for (i in 1:100) {
  ...
  result <- ACS_Alg_O(obs_gen_para, k = 4, lambda)
...
saveRDS(results_0, file.path(output_dir, "data_100_4_0.rds"))
...
saveRDS(results_05, file.path(output_dir, "data_100_4_05.rds"))
...
saveRDS(results_1, file.path(output_dir, "data_100_4_1.rds"))
...
saveRDS(results_15, file.path(output_dir, "data_100_4_15.rds"))
...
saveRDS(results_2, file.path(output_dir, "data_100_4_2.rds"))
...
saveRDS(results_25, file.path(output_dir, "data_100_4_25.rds"))
...
saveRDS(results_3, file.path(output_dir, "data_100_4_3.rds"))
...
saveRDS(results_35, file.path(output_dir, "data_100_4_35.rds"))
...
saveRDS(results_4, file.path(output_dir, "data_100_4_4.rds"))
